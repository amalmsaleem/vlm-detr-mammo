...
def config():
    ...
    parser.add_argument('--tensorboard-path', metavar='DIR',
                        default='/mnt/hdd_10tb_sdb/amal/__breast__mammo/Mammo-main/detection_amal/log',
                        help='path to tensorboard logs')
    parser.add_argument('--checkpoints', metavar='DIR',
                        default='/mnt/hdd_10tb_sdb/amal/__breast__mammo/Mammo-main/detection_amal/checkpoints',
                        help='path to checkpoints')
    parser.add_argument('--output_path', metavar='DIR',
                        default='/mnt/hdd_10tb_sdb/amal/__breast__mammo/Mammo-main/detection_detr/',
                        help='path to output logs')
    parser.add_argument('--chk_pt_path', metavar='DIR',
                        default='/mnt/hdd_10tb_sdb/amal/__breast__mammo/Mammo-main/detection_amal/out',
                        help='path to save chks'),
    parser.add_argument(
        "--data-dir",
        default="",
    ...
    parser.add_argument("--csv-file", default="", type=str,
                        help="data csv file")
    parser.add_argument("--clip_chk_pt_path", default=None, type=str, help="Path to chkpt")
    ...
    parser.add_argument(
        ...
        ], help="select detection label from vinDr dataset"
    )
